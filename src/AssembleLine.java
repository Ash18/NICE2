    ...
    **/
    public String callInOut(String [] inst,String instAddress,int whichOp) {
        ...
        if(inst[1].charAt(0)=='X'||inst[1].charAt(0)=='x') {
            ...
            return error("Error:@ Line " + linecnt+ ": Ports are avilable upto " + "x17" +". \n ",instAddress);
        }
        // Note only hex constants for now
         else if( inst[1].charAt(0)=='#') {
                String rval=inst[1].substring(1);
                ...
                binInst[count++]= pad((Object)Integer.toBinaryString(Integer.parseInt(rval)),-8,"0");
                else
                return error("Error:@ Line " + linecnt+ ": Ports available upto " +"#23 " +". \n ",instAddress);
